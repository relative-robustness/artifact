...
ensures {:layer 1} ( (!VidValid[vid] && ActiveContestant[cid] && old(VoterPhoneToVotesCount[pnb][vid]) == 0 && 
                      (exists vid0:Vid:: vid0 != vid && VoterPhoneToVotesCount[pnb][vid] == 0) ==> 
                      (VidValid[vid] && VotesCid[vid] == cid && VotesPnb[vid] == pnb && 
                       VotesSid[vid] == AreaToState[acd] && VoterPhoneToVotesCount[pnb][vid] := 1) );
